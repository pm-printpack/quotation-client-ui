...
export interface CheckboxCardProps extends ChakraCheckboxCard.RootProps, React.Attributes {
...
>(function CheckboxCard(props, ref) {
  ...
  return (
    <ChakraCheckboxCard.Root {...rest}>
      <ChakraCheckboxCard.HiddenInput ref={ref} id={`${ rest.htmlFor || "" }` || undefined} {...inputProps} />
      <ChakraCheckboxCard.Control p="0">
